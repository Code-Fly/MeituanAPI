...
CREATE TABLE `meituan_order` (
	...
	`ctime` VARCHAR(36) NULL DEFAULT NULL COMMENT '创建时间 ',
	`utime` VARCHAR(36) NULL DEFAULT NULL COMMENT '更新时间 ',
	`delivery_time` VARCHAR(36) NULL DEFAULT NULL COMMENT '用户预计送达时间，“立即送达”时为0 ',
	...
	`latitude` VARCHAR(24) NULL DEFAULT NULL COMMENT '实际送餐地址纬度',
	`longitude` VARCHAR(24) NULL DEFAULT NULL COMMENT '实际送餐地址经度 ',
